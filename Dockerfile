...
FROM --platform=linux/arm64 composer:lts AS deps
...
FROM --platform=linux/arm64 php:8.3-apache AS final

LABEL org.opencontainers.image.source=https://github.com/conshmea/adam-rms
...
LABEL org.opencontainers.image.vendor="Conshmea"
...
RUN echo "error_log=/var/log/apache2/access.log\n" >> "$PHP_INI_DIR/php.ini"
